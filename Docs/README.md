# MediKiosk+ — AI Clinical History & ABDM Integration Platform
...
MediKiosk+ turns the wait-time before a consultation into a structured, AI-guided history-taking session — via voice, touch, or WhatsApp/IVR — and hands the doctor a clean, editable summary the moment the patient sits down.
