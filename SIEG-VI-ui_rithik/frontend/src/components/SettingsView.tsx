    ...
    <div className="w-full max-w-5xl mx-auto px-4 md:px-8 py-6 md:py-8">
      ...
      <form onSubmit={handleSave} className="mt-8 space-y-8">
        ...
        */}
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-[0px_4px_20px_rgba(45,90,61,0.04)] border border-[#c1c9c0]/30">
          <h2 className="text-[20px] font-bold text-[#1c1c19] tracking-tight mb-6 flex items-center gap-2.5">
            <span className="material-symbols-outlined text-[24px] text-[#a13f1f]">
              logout
            </span>
            Account & Session
          </h2>
          ...
          <div className="space-y-4">
            <p className="text-[14px] text-[#414942]">
              Securely log out from your AyurLife account. Your data will remain encrypted and secure.
            </p>
            ...
            <button
              ...
              className="w-full px-6 py-3 rounded-xl bg-[#a13f1f]/10 hover:bg-[#a13f1f]/20 text-[#a13f1f] font-bold text-[15px] flex items-center justify-center gap-2.5 transition-all active:scale-[0.98] border border-[#a13f1f]/30"
            >
              <span className="material-symbols-outlined text-[20px]">
                logout
              </span>
              Log Out from AyurLife
            </button>
          </div>
        </div>
