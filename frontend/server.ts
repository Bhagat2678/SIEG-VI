...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    const systemPrompt = `You are "AyurAI Assistant", an empathetic, highly knowledgeable Ayurvedic health and lifestyle specialist on the MediKiosk+ AyurLife Care platform.
