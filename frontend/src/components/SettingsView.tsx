...
export const SettingsView: React.FC<SettingsViewProps> = ({ userProfile, onUpdateProfile }) => {
  ...
  const [newDeviceType, setNewDeviceType] = useState('Pulse Oximeter');
  ...
  const handleAddDevice = () => {
    ...
    setForm((prev) => ({
      ...prev,
      connectedDevices: [...prev.connectedDevices, newDev],
    }));
    setNewDeviceName('');
  ...
  const handleRemoveDevice = (id: string) => {
    setForm((prev) => ({
      ...prev,
      connectedDevices: prev.connectedDevices.filter((d) => d.id !== id),
    }));
  };
    ...
    <div className="w-full max-w-5xl mx-auto px-4 md:px-8 py-6 md:py-8">
      ...
      {isSaved && (
        <div className="mb-6 p-4 rounded-xl bg-[#2d5a3d] text-white flex items-center justify-between shadow-lg animate-in fade-in slide-in-from-top duration-200">
          ...
          <button type="button" onClick={() => setIsSaved(false)} className="text-white/80 hover:text-white">
      ...
      <form onSubmit={handleSave} className="mt-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-[0px_4px_20px_rgba(45,90,61,0.04)] border border-[#c1c9c0]/30">
          <h2 className="text-[20px] font-bold text-[#1c1c19] tracking-tight mb-6 flex items-center gap-2.5">
            <span className="material-symbols-outlined text-[24px] text-[#144227]">badge</span>
            Account Information
          </h2>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-[0px_4px_20px_rgba(45,90,61,0.04)] border border-[#c1c9c0]/30">
          <h2 className="text-[20px] font-bold text-[#1c1c19] tracking-tight mb-6 flex items-center gap-2.5">
            <span className="material-symbols-outlined text-[24px] text-[#144227]">security</span>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-[#f7f3ee]/60 border border-[#c1c9c0]/30">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[15px] text-[#1c1c19]">Kiosk Touch Terminal Mode</h3>
              ...
              <label className="relative inline-flex items-center cursor-pointer shrink-0">
                <input
                  ...
                  onChange={(e) => setForm({ ...form, kioskMode: e.target.checked })}
            ...
            <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-[#f7f3ee]/60 border border-[#c1c9c0]/30">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[15px] text-[#1c1c19]">Contribute to Ayurvedic Health Studies</h3>
                  <p className="text-[13px] text-[#414942] mt-0.5">
              ...
              <label className="relative inline-flex items-center cursor-pointer shrink-0">
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      privacy: { ...form.privacy, shareDataForResearch: e.target.checked },
                    })
                  }
                  className="sr-only peer"
                />
            ...
            <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-[#f7f3ee]/60 border border-[#c1c9c0]/30">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[15px] text-[#1c1c19]">Two-Factor Authentication (OTP on Access)</h3>
                  <p className="text-[13px] text-[#414942] mt-0.5">
              ...
              <label className="relative inline-flex items-center cursor-pointer shrink-0">
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      privacy: { ...form.privacy, twoFactorAuth: e.target.checked },
                    })
                  }
                  className="sr-only peer"
                />
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-[0px_4px_20px_rgba(45,90,61,0.04)] border border-[#c1c9c0]/30">
          <div className="flex items-center justify-between gap-4 mb-6">
            <h2 className="text-[20px] font-bold text-[#1c1c19] tracking-tight flex items-center gap-2.5">
              <span className="material-symbols-outlined text-[24px] text-[#144227]">sensors</span>
            ...
            {form.connectedDevices.map((dev) => (
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <h3 className="font-bold text-[15px] text-[#1c1c19]">{dev.name}</h3>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-[#c1c9c0]/30 animate-in fade-in zoom-in-95">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-[18px] text-[#144227]">Pair Diagnostic Sensor</h3>
              <button
                type="button"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-[#f1ede8] text-[#1c1c19] border border-[#c1c9c0]/40 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#144227] text-[14px]"
                >
                  <option value="Pulse Oximeter">Pulse Oximeter (SpO2)</option>
                  <option value="Nadi Pulse Terminal">Nadi Pulse Terminal</option>
                  <option value="Smart ECG Patch">Smart ECG Patch</option>
                  <option value="Blood Glucose Monitor">Blood Glucose Monitor</option>
